...
CSRF_TRUSTED_ORIGINS = [
    "https://rodcasio-8000.theiadockernext-1-labs-prod-theiak8s-4"
    "-tor01.proxy.cognitiveclass.ai",
    "https://*.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy"
    ".cognitiveclass.ai",
    "https://*.theianext-1-labs-prod-misc-tools-us-east-0.proxy"
    ".cognitiveclass.ai",
]
